...
DATABASES = {
    'default': {
        ...
        'NAME': 'scoutcharter.sqlite',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['scoutcharter-21273.usw1.actionbox.io', 'www.scoutcharter.com']
...
STATICFILES_DIRS = (
    ...
    '/home/action/workspace/scoutcharter/scoutcharter/static',
)
...
SECRET_KEY = '1a2i9*5%oxb70w%90gx^ggrurkw3)u8#+@j884)^n+@cm-^%5b'
...
EMAIL_HOST = os.environ['SC_EMAIL_HOST']
EMAIL_PORT = os.environ['SC_EMAIL_PORT']
